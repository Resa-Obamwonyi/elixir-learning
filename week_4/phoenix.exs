...
- The core_components.ex file is where you find the default components generated by the generators. It is found in hello_web/components
...
TO-DO:
- Try to write your own component
- Write a component that takes one product, call it product overview, put it into product_html module, define required arguments, "product"
    it should render each product with the structure shared, and use inside show template

Extra: see if you can add image
